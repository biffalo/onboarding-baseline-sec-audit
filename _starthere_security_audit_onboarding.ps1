...
Invoke-WebRequest -Uri "https://github.com/biffalo/onboarding-baseline-sec-audit/raw/master/office-365-have-i-been-pwned-check.ps1" -OutFile "$working\office-365-have-i-been-pwned-check.ps1"
Invoke-WebRequest -Uri "https://github.com/biffalo/onboarding-baseline-sec-audit/raw/master/aduc-bad-pass-check.ps1" -OutFile "$working\aduc-bad-pass-check.ps1"
Invoke-WebRequest -Uri "https://github.com/biffalo/onboarding-baseline-sec-audit/raw/master/inactive-user-check.ps1" -OutFile "$working\inactive-user-check.ps1"
Invoke-WebRequest -Uri "https://github.com/biffalo/onboarding-baseline-sec-audit/raw/master/admin-group-checker.ps1" -OutFile "$working\admin-group-checker.ps1"
